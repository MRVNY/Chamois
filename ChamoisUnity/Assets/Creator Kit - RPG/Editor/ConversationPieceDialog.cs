...
namespace RPGM.Gameplay
{
    ...
    public class ConversationPieceDialog : ScriptableWizard
    {
        ...
        internal static void New(ConversationScript conversationScript)
        {
            ...
            w.conversationPiece = new ConversationPiece() { id = "", text = "", options = new List<ConversationOption>(), hint = "" };
            w.isUpdate = false;
        }
        ...
        protected override bool DrawWizardGUI()
        {
            ...
            EditorGUILayout.PrefixLabel("Hint Encyclopedie");
            conversationPiece.hint = EditorGUILayout.TextField(conversationPiece.hint).Trim();
